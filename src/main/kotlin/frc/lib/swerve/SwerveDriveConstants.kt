...
object SwerveDriveConstants {
    ...
    val modules = listOf(
            ModuleConstants(1, Rotation2d.fromDegrees(145.1), 1, 2, 0, true, false, PIDController(0.0105, 0.00, 0.0)),
            ModuleConstants(2, Rotation2d.fromDegrees(8.1), 3, 4, 1, false, false, PIDController(0.011, 0.000, 0.0)),
            ModuleConstants(3, Rotation2d.fromDegrees(140.5), 5, 6, 2, false, false, PIDController(0.011, 0.00, 0.0)),
            ModuleConstants(4, Rotation2d.fromDegrees(-94.0), 7, 8, 3, false, false, PIDController(0.011, 0.00, 0.0))
    )
}